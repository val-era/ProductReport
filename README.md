...
В папке с файлом программы будет находиться база данных – файл (_ProductReportDB.db_). $${\color{red}**Не удаляйте данный файл**}$$, это БД, где будут храниться фотографии товаров для отчетности. Данный файл может занимать много места, зависит от кол-во фотографий, загруженных в БД. БД создается автоматически при отработке определенных функций.
