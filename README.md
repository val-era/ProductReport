...
$${\color{red}Загрузочный\spaceфайл\spaceдолжен\spaceбыть\spaceв\spaceформате \space A:A\space–\spaceартикулы\spaceтовара\spaceв\spaceячейках,}$$ 
 $${\color{red}B:B\space–\spaceпустые\spaceячейки\spaceпод\spaceфотографии}$$, остальные колонки могут быть заполнены произвольными данными или быть пустыми.
...
$${\color{red}На\spaceвход\spaceпринимается\spaceабсолютный\spaceпуть\spaceк\spaceпапке\spaceс\spaceфотографиями.}$$ $${\color{red}Фотографии\spaceдолжны\spaceбыть\spaceв\spaceформатах\space .jpg,\space .png,\space .jpeg.}$$ Имена фотографий должны быть равны артикулу в фото, т.е. Имя файла – артикул товара.**
