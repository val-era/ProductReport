...
Абсолютный путь можно получить, нажав правой кнопкой мыши по файлу и выбрав блок свойства. Абсолютный путь в данном способе получается, как _Расположение файла + имя файла с расширением_
...
Добро пожаловать в программу для создания отчетов, подробную инструкцию вы можете изучить на <https://github.com/val-era/ProductReport>
...
**4\. - Отчеты Best Sellers и Sales Analyses**
...
**5\. Загрузка фотографий в файл .xlsx**
...
**6\. Загрузка фотографий товаров в БД**
...
**7\. Замена существующих фотографий в базе данных**
...
**9\. Проверка фотографий по списку в папке и удаление лишних фотографий**
...
**10\. Удаление фотографий из базы данных по списку**
...
**11\. Получение фотографий присутствующих в БД**
