...
<h1>Оглавление:</h1>
  ...
  <h4>Функционал программы</h4>
  <h4>Отчеты Best Sellers и Sales Analyses</h4>
  <h4>Загрузка фотографий в файл .xlsx</h4>
  <h4>Загрузка фотографий товаров в БД</h4>
  <h4>Замена существующих фотографий в базе данных</h4>
  <h4>Сохранение фотографий товаров из базы данных в папку по списку</h4>
  <h4>Проверка фотографий по списку в папке и удаление лишних фотографий</h4>
  <h4>Удаление фотографий из базы данных по списку</h4>
  <h4>Получение фотографий в БД</h4>
  <h4>Комментарии</h4>
